    ...
    with col:
        ...
        st.markdown(
            ...
            <div style="text-align:center;margin-bottom:2rem;">
                <div style="font-family:JetBrains Mono,monospace;font-size:0.6rem;
                            ...
                            color:#1e3a4a;margin-bottom:12px;">
                    ◈ INITIALISING SYSTEM
                </div>
                <h1 style="font-family:Orbitron,monospace;font-size:2.2rem;
                           font-weight:900;color:#00d4ff;letter-spacing:0.08em;
        ...
        with tab_login:
            username = st.text_input(
                "Username", key="login_user", placeholder="Enter username"
            )
        ...
        with tab_register:
            reg_user = st.text_input(
                "Choose username", key="reg_user", placeholder="Username"
            )
            reg_pw = st.text_input(
                "Choose password", type="password", key="reg_pw",
        ...
        st.markdown(
            ...
            <div style="padding:0.5rem 0 1rem;">
                <div style="font-family:JetBrains Mono,monospace;font-size:0.58rem;
                            letter-spacing:0.2em;text-transform:uppercase;color:#1e3a4a;
                            margin-bottom:6px;">◈ AUTHENTICATED</div>
                <div style="font-family:Orbitron,monospace;font-size:1rem;
                            font-weight:700;color:#e8f4f8;letter-spacing:0.04em;">
                    {user[1]}
                </div>
                <div style="font-family:JetBrains Mono,monospace;font-size:0.7rem;
                            color:#00d4ff;margin-top:3px;letter-spacing:0.08em;">
                    {role.upper()}
                </div>
            </div>
            """,
